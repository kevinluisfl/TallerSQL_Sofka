...
(product_id, supplier_id, since) VALUES (id_producto, NEW.supplier_id, CURDATE());
...
INSERT INTO product_supplier (product_id, supplier_id, since) VALUES (id_producto, NEW.supplier_id, CURDATE());
END IF;
END $$
DELIMITER ;
