...
SELECT c.customer_name AS Customer, c.type_id AS Type_Id , c.number_id AS Number_Id,  p.product_name AS Product
FROM sale_detail sd
...
WHERE c.type_id = 'CC' AND c.number_id = '136823322';
